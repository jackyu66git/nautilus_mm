"""CHAN_BI_OF_STRATA_001M_001. Same protocol. Structure TF = 1m only."""
...
from chan_bi_of_strata_1m.paths import BAR_MINUTES, KLINE_1M, LOG, OF_1M
...
def main() -> None:
    ...
    lines = [
        f"CHAN_BI_OF_STRATA_001M_001  decision={result['decision']}  kind={result['kind']}",
        f"scale=1m bi-endpoint + 1m OF  n_bars={result['n_15m']} n_ep={result['n_events']}",
        "15m=FAIL/NO_GRADIENT  5m=FAIL/MFE_ONLY  (immutable)",
        "",
    ]
